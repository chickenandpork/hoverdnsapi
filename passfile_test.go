...
var BasicTests = []struct {
	Name     string
	Config   string
	Expected hoverdnsapi.PlaintextAuth
}{
	{"scott/tiger", `{"username": "scott", "plaintextpassword": "tiger"}`, hoverdnsapi.PlaintextAuth{Username: "scott", PlaintextPassword: "tiger"}},
}

func TestParseJson(t *testing.T) {
	for _, tt := range BasicTests {
		t.Run(tt.Name, func(t *testing.T) {
			var observed hoverdnsapi.PlaintextAuth
